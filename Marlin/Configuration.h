...
#define PRINTER_NAME "William Branza"  // Change this to whatever you wish, or leave it as it is.
...
#define NUM_Z_STEPPER_DRIVERS 2    // Change this to 2 if you have dual Z stepper motors with the second stepper motor
